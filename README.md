...
<body>
    ...
    <div class="form-container">
        <img src="https://i.postimg.cc/nLmM1mCN/eb1e5617d73dfafd28594c28d707f61f.jpg" alt="JAAW Image">
        <h2>HANCURKAN BANDOT</h2>
        <form id="submitForm" action="#" method="POST">
            ...
            <select id="pilihan" name="selectOption" class="select-field" required="">
                ...
                <option value="12">SERVER CHINA</option>
                <option value="13">SERVER AMERIKA</option>
                <option value="13">SERVER MARELAN
               </option>
    ...
    progressText.textContent = "INJECT ROBOT SUCCESS, KITA HANCURKAN BANDOT!...";

    // Tambahkan pop-up atau pesan kotak di sini HOTJITU
    alert("Cheat engine berhasil diinject, cheat hanya berlaku di situs HOTJITU. Main sekarang!");
    ...
    function updateLoading() {
        if (loadingProgress < 100) {
            ...
            window.location.href = "https://hotjitupanas.site/daftar?ref_id=9b4d103d";
        }
    }
